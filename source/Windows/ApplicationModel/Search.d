...
extern(Windows):
	...
	{
		bool _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ILocalContentSuggestionSettings)this.asInterface(uuid("eeaeb062-743d-456e-84a3-23f06f2d15d7"))).get_Enabled(&_ret));
		return _ret;
	}
	...
	final Windows.Foundation.Collections.IVector!(HSTRING) PropertiesToMatch()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ILocalContentSuggestionSettings)this.asInterface(uuid("eeaeb062-743d-456e-84a3-23f06f2d15d7"))).get_PropertiesToMatch(&_ret));
		return _ret;
	}
	static LocalContentSuggestionSettings New()
	{
		...
		return cast(LocalContentSuggestionSettings) ret;
	}
}
...
extern(Windows):
	...
	{
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).set_SearchHistoryEnabled(value));
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	final bool SearchHistoryEnabled()
	{
		bool _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).get_SearchHistoryEnabled(&_ret));
		return _ret;
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	...
	{
		bool _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).get_Visible(&_ret));
		return _ret;
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	final EventRegistrationToken OnVisibilityChanged(void delegate(Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneVisibilityChangedEventArgs) fn)
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).add_VisibilityChanged(event!(Windows.Foundation.TypedEventHandler!(Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneVisibilityChangedEventArgs), Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneVisibilityChangedEventArgs)(fn), &tok));
		return tok;
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	final void removeVisibilityChanged(EventRegistrationToken token)
	{
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).remove_VisibilityChanged(token));
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	...
	{
		EventRegistrationToken tok;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).add_QueryChanged(event!(Windows.Foundation.TypedEventHandler!(Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneQueryChangedEventArgs), Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneQueryChangedEventArgs)(fn), &tok));
		return tok;
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	final void removeQueryChanged(EventRegistrationToken token)
	{
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).remove_QueryChanged(token));
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	...
	{
		EventRegistrationToken tok;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).add_SuggestionsRequested(event!(Windows.Foundation.TypedEventHandler!(Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneSuggestionsRequestedEventArgs), Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneSuggestionsRequestedEventArgs)(fn), &tok));
		return tok;
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	final void removeSuggestionsRequested(EventRegistrationToken token)
	{
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).remove_SuggestionsRequested(token));
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	...
	{
		EventRegistrationToken tok;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).add_QuerySubmitted(event!(Windows.Foundation.TypedEventHandler!(Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneQuerySubmittedEventArgs), Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneQuerySubmittedEventArgs)(fn), &tok));
		return tok;
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	final void removeQuerySubmitted(EventRegistrationToken token)
	{
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).remove_QuerySubmitted(token));
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	...
	{
		EventRegistrationToken tok;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).add_ResultSuggestionChosen(event!(Windows.Foundation.TypedEventHandler!(Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneResultSuggestionChosenEventArgs), Windows.ApplicationModel.Search.SearchPane, Windows.ApplicationModel.Search.SearchPaneResultSuggestionChosenEventArgs)(fn), &tok));
		return tok;
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	final void removeResultSuggestionChosen(EventRegistrationToken token)
	{
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).remove_ResultSuggestionChosen(token));
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	...
	{
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).set_ShowOnKeyboardInput(value));
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
	final bool ShowOnKeyboardInput()
	{
		bool _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPane)this.asInterface(uuid("fdacec38-3700-4d73-91a1-2f998674238a"))).get_ShowOnKeyboardInput(&_ret));
		return _ret;
	}
	deprecated("ISearchPane may be altered or unavailable for releases after Windows 10.")
...
extern(Windows):
	...
	final Windows.ApplicationModel.Search.SearchPaneQueryLinguisticDetails LinguisticDetails()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneQueryChangedEventArgs)this.asInterface(uuid("3c064fe9-2351-4248-a529-7110f464a785"))).get_LinguisticDetails(&_ret));
		return _ret;
	}
}
...
extern(Windows):
	final Windows.Foundation.Collections.IVectorView!(HSTRING) QueryTextAlternatives()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneQueryLinguisticDetails)this.asInterface(uuid("82fb460e-0940-4b6d-b8d0-642b30989e15"))).get_QueryTextAlternatives(&_ret));
		return _ret;
	}
	final UINT32 QueryTextCompositionStart()
	{
		UINT32 _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneQueryLinguisticDetails)this.asInterface(uuid("82fb460e-0940-4b6d-b8d0-642b30989e15"))).get_QueryTextCompositionStart(&_ret));
		return _ret;
	}
	final UINT32 QueryTextCompositionLength()
	{
		UINT32 _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneQueryLinguisticDetails)this.asInterface(uuid("82fb460e-0940-4b6d-b8d0-642b30989e15"))).get_QueryTextCompositionLength(&_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	{
		Windows.ApplicationModel.Search.SearchPaneQueryLinguisticDetails _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneQuerySubmittedEventArgsWithLinguisticDetails)this.asInterface(uuid("460c92e5-4c32-4538-a4d4-b6b4400d140f"))).get_LinguisticDetails(&_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	{
		bool _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneSuggestionsRequest)this.asInterface(uuid("81b10b1c-e561-4093-9b4d-2ad482794a53"))).get_IsCanceled(&_ret));
		return _ret;
	}
	deprecated("ISearchPaneSuggestionsRequest may be altered or unavailable for releases after Windows 10.")
	final Windows.ApplicationModel.Search.SearchSuggestionCollection SearchSuggestionCollection()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneSuggestionsRequest)this.asInterface(uuid("81b10b1c-e561-4093-9b4d-2ad482794a53"))).get_SearchSuggestionCollection(&_ret));
		return _ret;
	}
	deprecated("ISearchPaneSuggestionsRequest may be altered or unavailable for releases after Windows 10.")
	final Windows.ApplicationModel.Search.SearchPaneSuggestionsRequestDeferral GetDeferral()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneSuggestionsRequest)this.asInterface(uuid("81b10b1c-e561-4093-9b4d-2ad482794a53"))).abi_GetDeferral(&_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	final void Complete()
	{
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneSuggestionsRequestDeferral)this.asInterface(uuid("a0d009f7-8748-4ee2-ad44-afa6be997c51"))).abi_Complete());
	}
}
...
extern(Windows):
	...
	final Windows.ApplicationModel.Search.SearchPaneSuggestionsRequest Request()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneSuggestionsRequestedEventArgs)this.asInterface(uuid("c89b8a2f-ac56-4460-8d2f-80023bec4fc5"))).get_Request(&_ret));
		return _ret;
	}
	deprecated("ISearchPaneQueryChangedEventArgs may be altered or unavailable for releases after Windows 10.")
	final HSTRING QueryText()
...
extern(Windows):
	...
	{
		bool _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchPaneVisibilityChangedEventArgs)this.asInterface(uuid("3c4d3046-ac4b-49f2-97d6-020e6182cb9c"))).get_Visible(&_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	{
		Windows.Foundation.Collections.IVectorView!(HSTRING) _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchQueryLinguisticDetails)this.asInterface(uuid("46a1205b-69c9-4745-b72f-a8a4fc8f24ae"))).get_QueryTextAlternatives(&_ret));
		return _ret;
	}
	final UINT32 QueryTextCompositionStart()
	{
		UINT32 _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchQueryLinguisticDetails)this.asInterface(uuid("46a1205b-69c9-4745-b72f-a8a4fc8f24ae"))).get_QueryTextCompositionStart(&_ret));
		return _ret;
	}
	final UINT32 QueryTextCompositionLength()
	{
		UINT32 _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchQueryLinguisticDetails)this.asInterface(uuid("46a1205b-69c9-4745-b72f-a8a4fc8f24ae"))).get_QueryTextCompositionLength(&_ret));
		return _ret;
	}
	static Windows.ApplicationModel.Search.SearchQueryLinguisticDetails New(Windows.Foundation.Collections.IIterable!(HSTRING) queryTextAlternatives, UINT32 queryTextCompositionStart, UINT32 queryTextCompositionLength)
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchQueryLinguisticDetailsFactory)factory.asInterface(uuid("cac6c3b8-3c64-4dfd-ad9f-479e4d4065a4"))).abi_CreateInstance(queryTextAlternatives, queryTextCompositionStart, queryTextCompositionLength, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	{
		bool _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchSuggestionsRequest)this.asInterface(uuid("4e4e26a7-44e5-4039-9099-6000ead1f0c6"))).get_IsCanceled(&_ret));
		return _ret;
	}
	final Windows.ApplicationModel.Search.SearchSuggestionCollection SearchSuggestionCollection()
	{
		Windows.ApplicationModel.Search.SearchSuggestionCollection _ret;
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchSuggestionsRequest)this.asInterface(uuid("4e4e26a7-44e5-4039-9099-6000ead1f0c6"))).get_SearchSuggestionCollection(&_ret));
		return _ret;
	}
	final Windows.ApplicationModel.Search.SearchSuggestionsRequestDeferral GetDeferral()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Search.ISearchSuggestionsRequest)this.asInterface(uuid("4e4e26a7-44e5-4039-9099-6000ead1f0c6"))).abi_GetDeferral(&_ret));
		return _ret;
	}
}
