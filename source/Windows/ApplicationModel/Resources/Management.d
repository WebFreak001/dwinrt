...
extern(Windows):
	final Windows.ApplicationModel.Resources.Management.IndexedResourceType Type()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IIndexedResourceCandidate)this.asInterface(uuid("0e619ef3-faec-4414-a9d7-54acd5953f29"))).get_Type(&_ret));
		return _ret;
	}
	final Windows.Foundation.Uri Uri()
	{
		Windows.Foundation.Uri _ret;
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IIndexedResourceCandidate)this.asInterface(uuid("0e619ef3-faec-4414-a9d7-54acd5953f29"))).get_Uri(&_ret));
		return _ret;
	}
	final Windows.Foundation.Collections.IMapView!(HSTRING, HSTRING) Metadata()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IIndexedResourceCandidate)this.asInterface(uuid("0e619ef3-faec-4414-a9d7-54acd5953f29"))).get_Metadata(&_ret));
		return _ret;
	}
	final Windows.Foundation.Collections.IVectorView!(Windows.ApplicationModel.Resources.Management.IndexedResourceQualifier) Qualifiers()
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IIndexedResourceCandidate)this.asInterface(uuid("0e619ef3-faec-4414-a9d7-54acd5953f29"))).get_Qualifiers(&_ret));
		return _ret;
	}
	final HSTRING ValueAsString()
	{
		HSTRING _ret;
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IIndexedResourceCandidate)this.asInterface(uuid("0e619ef3-faec-4414-a9d7-54acd5953f29"))).get_ValueAsString(&_ret));
		return _ret;
	}
	final HSTRING GetQualifierValue(HSTRING qualifierName)
	{
		HSTRING _ret;
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IIndexedResourceCandidate)this.asInterface(uuid("0e619ef3-faec-4414-a9d7-54acd5953f29"))).abi_GetQualifierValue(qualifierName, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	{
		HSTRING _ret;
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IIndexedResourceQualifier)this.asInterface(uuid("dae3bb9b-d304-497f-a168-a340042c8adb"))).get_QualifierName(&_ret));
		return _ret;
	}
	final HSTRING QualifierValue()
	{
		HSTRING _ret;
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IIndexedResourceQualifier)this.asInterface(uuid("dae3bb9b-d304-497f-a168-a340042c8adb"))).get_QualifierValue(&_ret));
		return _ret;
	}
}
...
extern(Windows):
	final Windows.ApplicationModel.Resources.Management.IndexedResourceCandidate IndexFilePath(Windows.Foundation.Uri filePath)
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IResourceIndexer)this.asInterface(uuid("2d4cf9a5-e32f-4ab2-8748-96350a016da3"))).abi_IndexFilePath(filePath, &_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.ApplicationModel.Resources.Management.IndexedResourceCandidate)) IndexFileContentsAsync(Windows.Foundation.Uri file)
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IResourceIndexer)this.asInterface(uuid("2d4cf9a5-e32f-4ab2-8748-96350a016da3"))).abi_IndexFileContentsAsync(file, &_ret));
		return _ret;
	}
	static Windows.ApplicationModel.Resources.Management.ResourceIndexer New(Windows.Foundation.Uri projectRoot)
	{
		...
		Debug.OK((cast(Windows.ApplicationModel.Resources.Management.IResourceIndexerFactory)factory.asInterface(uuid("b8de3f09-31cd-4d97-bd30-8d39f742bc61"))).abi_CreateResourceIndexer(projectRoot, &_ret));
		return _ret;
	}
}
