...
extern(Windows):
	...
	HRESULT abi_GetPropertiesAsync(UINT32 startIndex, UINT32 maxItems, Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Foundation.Collections.IMapView!(HSTRING, IInspectable)))* return_operation);
	...
	HRESULT abi_GetAsync(UINT32 startIndex, UINT32 maxItems, Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.Search.IIndexableContent))* return_operation);
...
{
extern(Windows):
	HRESULT abi_CreateQuery(HSTRING searchFilter, Windows.Foundation.Collections.IIterable!(HSTRING) propertiesToRetrieve, Windows.Foundation.Collections.IIterable!(Windows.Storage.Search.SortEntry) sortOrder, HSTRING searchFilterLanguage, Windows.Storage.Search.ContentIndexerQuery* return_query);
	HRESULT abi_CreateQuery(HSTRING searchFilter, Windows.Foundation.Collections.IIterable!(HSTRING) propertiesToRetrieve, Windows.Foundation.Collections.IIterable!(Windows.Storage.Search.SortEntry) sortOrder, Windows.Storage.Search.ContentIndexerQuery* return_query);
...
{
extern(Windows):
	HRESULT abi_GetIndexer(HSTRING indexName, Windows.Storage.Search.ContentIndexer* return_index);
...
extern(Windows):
	...
	HRESULT abi_CreateFileQuery(Windows.Storage.Search.StorageFileQueryResult* return_value);
	...
	HRESULT abi_CreateFolderQuery(Windows.Storage.Search.StorageFolderQueryResult* return_value);
	...
	HRESULT abi_GetFilesAsync(Windows.Storage.Search.CommonFileQuery query, Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.StorageFile))* return_operation);
	...
	HRESULT abi_GetFoldersAsync(Windows.Storage.Search.CommonFolderQuery query, Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.StorageFolder))* return_operation);
...
extern(Windows):
	final Windows.Foundation.IAsyncAction AddAsync(Windows.Storage.Search.IIndexableContent indexableContent)
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IContentIndexer)this.asInterface(uuid("b1767f8d-f698-4982-b05f-3a6e8cab01a2"))).abi_AddAsync(indexableContent, &_ret));
		return _ret;
	}
	...
	{
		Windows.Foundation.IAsyncAction _ret;
		Debug.OK((cast(Windows.Storage.Search.IContentIndexer)this.asInterface(uuid("b1767f8d-f698-4982-b05f-3a6e8cab01a2"))).abi_DeleteMultipleAsync(contentIds, &_ret));
		return _ret;
	}
	...
	final Windows.Storage.Search.ContentIndexerQuery CreateQuery(HSTRING searchFilter, Windows.Foundation.Collections.IIterable!(HSTRING) propertiesToRetrieve, Windows.Foundation.Collections.IIterable!(Windows.Storage.Search.SortEntry) sortOrder, HSTRING searchFilterLanguage)
	{
		Windows.Storage.Search.ContentIndexerQuery _ret;
		Debug.OK((cast(Windows.Storage.Search.IContentIndexerQueryOperations)this.asInterface(uuid("28823e10-4786-42f1-9730-792b3566b150"))).abi_CreateQuery(searchFilter, propertiesToRetrieve, sortOrder, searchFilterLanguage, &_ret));
		return _ret;
	}
	final Windows.Storage.Search.ContentIndexerQuery CreateQuery(HSTRING searchFilter, Windows.Foundation.Collections.IIterable!(HSTRING) propertiesToRetrieve, Windows.Foundation.Collections.IIterable!(Windows.Storage.Search.SortEntry) sortOrder)
	{
		Windows.Storage.Search.ContentIndexerQuery _ret;
		Debug.OK((cast(Windows.Storage.Search.IContentIndexerQueryOperations)this.asInterface(uuid("28823e10-4786-42f1-9730-792b3566b150"))).abi_CreateQuery(searchFilter, propertiesToRetrieve, sortOrder, &_ret));
		return _ret;
	}
	...
	static Windows.Storage.Search.ContentIndexer GetIndexer(HSTRING indexName)
	{
		Windows.Storage.Search.ContentIndexer _ret;
		Debug.OK(staticInstance.abi_GetIndexer(indexName, &_ret));
		return _ret;
	}
	static Windows.Storage.Search.ContentIndexer GetIndexer()
	{
		Windows.Storage.Search.ContentIndexer _ret;
		Debug.OK(staticInstance.abi_GetIndexer(&_ret));
		return _ret;
	}
}
...
extern(Windows):
	final Windows.Foundation.IAsyncOperation!(UINT32) GetCountAsync()
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IContentIndexerQuery)this.asInterface(uuid("70e3b0f8-4bfc-428a-8889-cc51da9a7b9d"))).abi_GetCountAsync(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Foundation.Collections.IMapView!(HSTRING, IInspectable))) GetPropertiesAsync()
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IContentIndexerQuery)this.asInterface(uuid("70e3b0f8-4bfc-428a-8889-cc51da9a7b9d"))).abi_GetPropertiesAsync(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Foundation.Collections.IMapView!(HSTRING, IInspectable))) GetPropertiesAsync(UINT32 startIndex, UINT32 maxItems)
	{
		Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Foundation.Collections.IMapView!(HSTRING, IInspectable))) _ret;
		Debug.OK((cast(Windows.Storage.Search.IContentIndexerQuery)this.asInterface(uuid("70e3b0f8-4bfc-428a-8889-cc51da9a7b9d"))).abi_GetPropertiesAsync(startIndex, maxItems, &_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.Search.IIndexableContent)) GetAsync()
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IContentIndexerQuery)this.asInterface(uuid("70e3b0f8-4bfc-428a-8889-cc51da9a7b9d"))).abi_GetAsync(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.Search.IIndexableContent)) GetAsync(UINT32 startIndex, UINT32 maxItems)
	{
		Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.Search.IIndexableContent)) _ret;
		Debug.OK((cast(Windows.Storage.Search.IContentIndexerQuery)this.asInterface(uuid("70e3b0f8-4bfc-428a-8889-cc51da9a7b9d"))).abi_GetAsync(startIndex, maxItems, &_ret));
		return _ret;
	}
	final Windows.Storage.StorageFolder QueryFolder()
	{
		Windows.Storage.StorageFolder _ret;
		Debug.OK((cast(Windows.Storage.Search.IContentIndexerQuery)this.asInterface(uuid("70e3b0f8-4bfc-428a-8889-cc51da9a7b9d"))).get_QueryFolder(&_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	final Windows.Foundation.Collections.IMap!(HSTRING, IInspectable) Properties()
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IIndexableContent)this.asInterface(uuid("ccf1a05f-d4b5-483a-b06e-e0db1ec420e4"))).get_Properties(&_ret));
		return _ret;
	}
	final Windows.Storage.Streams.IRandomAccessStream Stream()
	{
		Windows.Storage.Streams.IRandomAccessStream _ret;
		Debug.OK((cast(Windows.Storage.Search.IIndexableContent)this.asInterface(uuid("ccf1a05f-d4b5-483a-b06e-e0db1ec420e4"))).get_Stream(&_ret));
		return _ret;
	}
	...
	static IndexableContent New()
	{
		...
		return cast(IndexableContent) ret;
	}
}
...
extern(Windows):
	final Windows.Foundation.Collections.IVector!(HSTRING) FileTypeFilter()
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IQueryOptions)this.asInterface(uuid("1e5e46ee-0f45-4838-a8e9-d0479d446c30"))).get_FileTypeFilter(&_ret));
		return _ret;
	}
	final Windows.Storage.Search.FolderDepth FolderDepth()
	{
		Windows.Storage.Search.FolderDepth _ret;
		Debug.OK((cast(Windows.Storage.Search.IQueryOptions)this.asInterface(uuid("1e5e46ee-0f45-4838-a8e9-d0479d446c30"))).get_FolderDepth(&_ret));
		return _ret;
	}
	...
	final Windows.Storage.Search.IndexerOption IndexerOption()
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IQueryOptions)this.asInterface(uuid("1e5e46ee-0f45-4838-a8e9-d0479d446c30"))).get_IndexerOption(&_ret));
		return _ret;
	}
	final void IndexerOption(Windows.Storage.Search.IndexerOption value)
	{
		Debug.OK((cast(Windows.Storage.Search.IQueryOptions)this.asInterface(uuid("1e5e46ee-0f45-4838-a8e9-d0479d446c30"))).set_IndexerOption(value));
	}
	...
	{
		Debug.OK((cast(Windows.Storage.Search.IQueryOptions)this.asInterface(uuid("1e5e46ee-0f45-4838-a8e9-d0479d446c30"))).abi_SetThumbnailPrefetch(mode, requestedSize, options));
	}
	...
	{
		Debug.OK((cast(Windows.Storage.Search.IQueryOptions)this.asInterface(uuid("1e5e46ee-0f45-4838-a8e9-d0479d446c30"))).abi_SetPropertyPrefetch(options, propertiesToRetrieve));
	}
	final Windows.Foundation.Collections.IVector!(HSTRING) StorageProviderIdFilter()
	{
		Windows.Foundation.Collections.IVector!(HSTRING) _ret;
		Debug.OK((cast(Windows.Storage.Search.IQueryOptionsWithProviderFilter)this.asInterface(uuid("5b9d1026-15c4-44dd-b89a-47a59b7d7c4f"))).get_StorageProviderIdFilter(&_ret));
		return _ret;
	}
	...
	static Windows.Storage.Search.QueryOptions New(Windows.Storage.Search.CommonFileQuery query, Windows.Foundation.Collections.IIterable!(HSTRING) fileTypeFilter)
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IQueryOptionsFactory)factory.asInterface(uuid("032e1f8c-a9c1-4e71-8011-0dee9d4811a3"))).abi_CreateCommonFileQuery(query, fileTypeFilter, &_ret));
		return _ret;
	}
	static Windows.Storage.Search.QueryOptions New(Windows.Storage.Search.CommonFolderQuery query)
	{
		auto factory = factory!(Windows.Storage.Search.IQueryOptionsFactory);
		Windows.Storage.Search.QueryOptions _ret;
		Debug.OK((cast(Windows.Storage.Search.IQueryOptionsFactory)factory.asInterface(uuid("032e1f8c-a9c1-4e71-8011-0dee9d4811a3"))).abi_CreateCommonFolderQuery(query, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	final Windows.Storage.Search.SortEntry GetAt(uint index)
	{
		...
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).get_GetAt(index, &_ret));
		return _ret;
	}
	final uint Size()
	{
		uint _ret;
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).get_Size(&_ret));
		return _ret;
	}
	final void GetView(Windows.Foundation.Collections.IVectorView!(Windows.Storage.Search.SortEntry)* out_view)
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_GetView(out_view));
	}
	final uint IndexOf(Windows.Storage.Search.SortEntry value, bool* out_found)
	{
		uint _ret;
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).get_IndexOf(value, &_ret, out_found));
		return _ret;
	}
	final void SetAt(uint index, Windows.Storage.Search.SortEntry item)
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_SetAt(index, item));
	}
	final void InsertAt(uint index, Windows.Storage.Search.SortEntry item)
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_InsertAt(index, item));
	}
	final void RemoveAt(uint index)
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_RemoveAt(index));
	}
	final void Append(Windows.Storage.Search.SortEntry item)
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_Append(item));
	}
	final void RemoveAtEnd()
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_RemoveAtEnd());
	}
	final void Clear()
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_Clear());
	}
	final void GetMany(uint startIndex, uint capacity, Windows.Storage.Search.SortEntry* out_value, uint* out_actual)
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_GetMany(startIndex, capacity, out_value, out_actual));
	}
	final void ReplaceAll(uint count, Windows.Storage.Search.SortEntry* out_value)
	{
		Debug.OK((cast(Windows.Foundation.Collections.IVector!(Windows.Storage.Search.SortEntry))this).abi_ReplaceAll(count, out_value));
	}
	final void First(Windows.Foundation.Collections.IIterator!(Windows.Storage.Search.SortEntry)* out_first)
	{
		Debug.OK((cast(Windows.Foundation.Collections.IIterable!(Windows.Storage.Search.SortEntry))this).abi_First(out_first));
	}
}
...
extern(Windows):
	final Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.StorageFile)) GetFilesAsync(UINT32 startIndex, UINT32 maxNumberOfItems)
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IStorageFileQueryResult)this.asInterface(uuid("52fda447-2baa-412c-b29f-d4b1778efa1e"))).abi_GetFilesAsync(startIndex, maxNumberOfItems, &_ret));
		return _ret;
	}
	...
	{
		Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.StorageFile)) _ret;
		Debug.OK((cast(Windows.Storage.Search.IStorageFileQueryResult)this.asInterface(uuid("52fda447-2baa-412c-b29f-d4b1778efa1e"))).abi_GetFilesAsync(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(UINT32) GetItemCountAsync()
	{
		Windows.Foundation.IAsyncOperation!(UINT32) _ret;
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).abi_GetItemCountAsync(&_ret));
		return _ret;
	}
	final Windows.Storage.StorageFolder Folder()
	{
		Windows.Storage.StorageFolder _ret;
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).get_Folder(&_ret));
		return _ret;
	}
	final EventRegistrationToken OnContentsChanged(void delegate(Windows.Storage.Search.IStorageQueryResultBase, IInspectable) fn)
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).add_ContentsChanged(event!(Windows.Foundation.TypedEventHandler!(Windows.Storage.Search.IStorageQueryResultBase, IInspectable), Windows.Storage.Search.IStorageQueryResultBase, IInspectable)(fn), &tok));
		return tok;
	}
	final void removeContentsChanged(EventRegistrationToken eventCookie)
	{
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).remove_ContentsChanged(eventCookie));
	}
	...
	{
		EventRegistrationToken tok;
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).add_OptionsChanged(event!(Windows.Foundation.TypedEventHandler!(Windows.Storage.Search.IStorageQueryResultBase, IInspectable), Windows.Storage.Search.IStorageQueryResultBase, IInspectable)(fn), &tok));
		return tok;
	}
	final void removeOptionsChanged(EventRegistrationToken eventCookie)
	{
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).remove_OptionsChanged(eventCookie));
	}
	final Windows.Foundation.IAsyncOperation!(UINT32) FindStartIndexAsync(IInspectable value)
	{
		Windows.Foundation.IAsyncOperation!(UINT32) _ret;
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).abi_FindStartIndexAsync(value, &_ret));
		return _ret;
	}
	final Windows.Storage.Search.QueryOptions GetCurrentQueryOptions()
	{
		Windows.Storage.Search.QueryOptions _ret;
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).abi_GetCurrentQueryOptions(&_ret));
		return _ret;
	}
	final void ApplyNewQueryOptions(Windows.Storage.Search.QueryOptions newQueryOptions)
	{
		Debug.OK((cast(Windows.Storage.Search.IStorageQueryResultBase)this.asInterface(uuid("c297d70d-7353-47ab-ba58-8c61425dc54b"))).abi_ApplyNewQueryOptions(newQueryOptions));
	}
	final Windows.Foundation.Collections.IMap!(HSTRING, Windows.Foundation.Collections.IVectorView!(Windows.Data.Text.TextSegment)) GetMatchingPropertiesWithRanges(Windows.Storage.StorageFile file)
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IStorageFileQueryResult2)this.asInterface(uuid("4e5db9dd-7141-46c4-8be3-e9dc9e27275c"))).abi_GetMatchingPropertiesWithRanges(file, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	final Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.StorageFolder)) GetFoldersAsync(UINT32 startIndex, UINT32 maxNumberOfItems)
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IStorageFolderQueryResult)this.asInterface(uuid("6654c911-7d66-46fa-aecf-e4a4baa93ab8"))).abi_GetFoldersAsync(startIndex, maxNumberOfItems, &_ret));
		return _ret;
	}
	...
	{
		Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.StorageFolder)) _ret;
		Debug.OK((cast(Windows.Storage.Search.IStorageFolderQueryResult)this.asInterface(uuid("6654c911-7d66-46fa-aecf-e4a4baa93ab8"))).abi_GetFoldersAsync(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(UINT32) GetItemCountAsync()
	{
...
extern(Windows):
	final Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.IStorageItem)) GetItemsAsync(UINT32 startIndex, UINT32 maxNumberOfItems)
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IStorageItemQueryResult)this.asInterface(uuid("e8948079-9d58-47b8-b2b2-41b07f4795f9"))).abi_GetItemsAsync(startIndex, maxNumberOfItems, &_ret));
		return _ret;
	}
	...
	{
		Windows.Foundation.IAsyncOperation!(Windows.Foundation.Collections.IVectorView!(Windows.Storage.IStorageItem)) _ret;
		Debug.OK((cast(Windows.Storage.Search.IStorageItemQueryResult)this.asInterface(uuid("e8948079-9d58-47b8-b2b2-41b07f4795f9"))).abi_GetItemsAsync(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(UINT32) GetItemCountAsync()
	{
...
extern(Windows):
	...
	{
		Windows.Storage.StorageFolder _ret;
		Debug.OK((cast(Windows.Storage.Search.IStorageLibraryContentChangedTriggerDetails)this.asInterface(uuid("2a371977-abbf-4e1d-8aa5-6385d8884799"))).get_Folder(&_ret));
		return _ret;
	}
	final Windows.Storage.Search.StorageItemQueryResult CreateModifiedSinceQuery(Windows.Foundation.DateTime lastQueryTime)
	{
		...
		Debug.OK((cast(Windows.Storage.Search.IStorageLibraryContentChangedTriggerDetails)this.asInterface(uuid("2a371977-abbf-4e1d-8aa5-6385d8884799"))).abi_CreateModifiedSinceQuery(lastQueryTime, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	{
		IInspectable _ret;
		Debug.OK((cast(Windows.Storage.Search.IValueAndLanguage)this.asInterface(uuid("b9914881-a1ee-4bc4-92a5-466968e30436"))).get_Value(&_ret));
		return _ret;
	}
	final void Value(IInspectable value)
	{
		Debug.OK((cast(Windows.Storage.Search.IValueAndLanguage)this.asInterface(uuid("b9914881-a1ee-4bc4-92a5-466968e30436"))).set_Value(value));
	}
	static ValueAndLanguage New()
	{
		IInspectable ret;
		Debug.OK(activationFactory!(ValueAndLanguage).abi_ActivateInstance(&ret));
		return cast(ValueAndLanguage) ret;
	}
}
