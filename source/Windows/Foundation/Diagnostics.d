...
interface AsyncCausalityTracer
{
	...
	static void TraceOperationCreation(Windows.Foundation.Diagnostics.CausalityTraceLevel traceLevel, Windows.Foundation.Diagnostics.CausalitySource source, GUID platformId, ulong operationId, wstring operationName, ulong relatedContext)
	{
		Debug.OK(staticInstance.abi_TraceOperationCreation(traceLevel, source, platformId, operationId, hstring(operationName).handle, relatedContext));
	}
...
extern(Windows):
	...
	static Windows.Foundation.Diagnostics.FileLoggingSession New(wstring name)
	{
		...
		Debug.OK((cast(Windows.Foundation.Diagnostics.IFileLoggingSessionFactory)factory.asInterface(uuid("eea08dce-8447-4daa-9133-12eb46f697d4"))).abi_Create(hstring(name).handle, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	final void StopActivity(wstring stopEventName)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingActivity2)this.asInterface(uuid("26c29808-6322-456a-af82-80c8642f178b"))).abi_StopActivity(hstring(stopEventName).handle));
	}
	final void StopActivityWithFields(wstring stopEventName, Windows.Foundation.Diagnostics.LoggingFields fields)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingActivity2)this.asInterface(uuid("26c29808-6322-456a-af82-80c8642f178b"))).abi_StopActivityWithFields(hstring(stopEventName).handle, fields));
	}
	alias StopActivity = StopActivityWithFields;
	final void StopActivityWithFieldsAndOptions(wstring stopEventName, Windows.Foundation.Diagnostics.LoggingFields fields, Windows.Foundation.Diagnostics.LoggingOptions options)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingActivity2)this.asInterface(uuid("26c29808-6322-456a-af82-80c8642f178b"))).abi_StopActivityWithFieldsAndOptions(hstring(stopEventName).handle, fields, options));
	}
	...
	final void LogEvent(wstring eventName)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingTarget)this.asInterface(uuid("65f16c35-e388-4e26-b17a-f51cd3a83916"))).abi_LogEvent(hstring(eventName).handle));
	}
	final void LogEventWithFields(wstring eventName, Windows.Foundation.Diagnostics.LoggingFields fields)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingTarget)this.asInterface(uuid("65f16c35-e388-4e26-b17a-f51cd3a83916"))).abi_LogEventWithFields(hstring(eventName).handle, fields));
	}
	alias LogEvent = LogEventWithFields;
	final void LogEventWithFieldsAndLevel(wstring eventName, Windows.Foundation.Diagnostics.LoggingFields fields, Windows.Foundation.Diagnostics.LoggingLevel level)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingTarget)this.asInterface(uuid("65f16c35-e388-4e26-b17a-f51cd3a83916"))).abi_LogEventWithFieldsAndLevel(hstring(eventName).handle, fields, level));
	}
	alias LogEvent = LogEventWithFieldsAndLevel;
	final void LogEventWithFieldsAndOptions(wstring eventName, Windows.Foundation.Diagnostics.LoggingFields fields, Windows.Foundation.Diagnostics.LoggingLevel level, Windows.Foundation.Diagnostics.LoggingOptions options)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingTarget)this.asInterface(uuid("65f16c35-e388-4e26-b17a-f51cd3a83916"))).abi_LogEventWithFieldsAndOptions(hstring(eventName).handle, fields, level, options));
	}
	alias LogEvent = LogEventWithFieldsAndOptions;
	final Windows.Foundation.Diagnostics.LoggingActivity StartActivity(wstring startEventName)
	{
		Windows.Foundation.Diagnostics.LoggingActivity _ret;
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingTarget)this.asInterface(uuid("65f16c35-e388-4e26-b17a-f51cd3a83916"))).abi_StartActivity(hstring(startEventName).handle, &_ret));
		return _ret;
	}
	final Windows.Foundation.Diagnostics.LoggingActivity StartActivityWithFields(wstring startEventName, Windows.Foundation.Diagnostics.LoggingFields fields)
	{
		Windows.Foundation.Diagnostics.LoggingActivity _ret;
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingTarget)this.asInterface(uuid("65f16c35-e388-4e26-b17a-f51cd3a83916"))).abi_StartActivityWithFields(hstring(startEventName).handle, fields, &_ret));
		return _ret;
	}
	alias StartActivity = StartActivityWithFields;
	final Windows.Foundation.Diagnostics.LoggingActivity StartActivityWithFieldsAndLevel(wstring startEventName, Windows.Foundation.Diagnostics.LoggingFields fields, Windows.Foundation.Diagnostics.LoggingLevel level)
	{
		Windows.Foundation.Diagnostics.LoggingActivity _ret;
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingTarget)this.asInterface(uuid("65f16c35-e388-4e26-b17a-f51cd3a83916"))).abi_StartActivityWithFieldsAndLevel(hstring(startEventName).handle, fields, level, &_ret));
		return _ret;
	}
	alias StartActivity = StartActivityWithFieldsAndLevel;
	final Windows.Foundation.Diagnostics.LoggingActivity StartActivityWithFieldsAndOptions(wstring startEventName, Windows.Foundation.Diagnostics.LoggingFields fields, Windows.Foundation.Diagnostics.LoggingLevel level, Windows.Foundation.Diagnostics.LoggingOptions options)
	{
		Windows.Foundation.Diagnostics.LoggingActivity _ret;
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingTarget)this.asInterface(uuid("65f16c35-e388-4e26-b17a-f51cd3a83916"))).abi_StartActivityWithFieldsAndOptions(hstring(startEventName).handle, fields, level, options, &_ret));
		return _ret;
	}
	alias StartActivity = StartActivityWithFieldsAndOptions;
	static Windows.Foundation.Diagnostics.LoggingActivity New(wstring activityName, Windows.Foundation.Diagnostics.ILoggingChannel loggingChannel)
	{
		auto factory = factory!(Windows.Foundation.Diagnostics.ILoggingActivityFactory);
		Windows.Foundation.Diagnostics.LoggingActivity _ret;
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingActivityFactory)factory.asInterface(uuid("6b33b483-e10a-4c58-97d5-10fb451074fb"))).abi_CreateLoggingActivity(hstring(activityName).handle, loggingChannel, &_ret));
		return _ret;
	}
	static Windows.Foundation.Diagnostics.LoggingActivity New(wstring activityName, Windows.Foundation.Diagnostics.ILoggingChannel loggingChannel, Windows.Foundation.Diagnostics.LoggingLevel level)
	{
		auto factory = factory!(Windows.Foundation.Diagnostics.ILoggingActivityFactory);
		Windows.Foundation.Diagnostics.LoggingActivity _ret;
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingActivityFactory)factory.asInterface(uuid("6b33b483-e10a-4c58-97d5-10fb451074fb"))).abi_CreateLoggingActivityWithLevel(hstring(activityName).handle, loggingChannel, level, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	final void LogMessage(wstring eventString)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingChannel)this.asInterface(uuid("e9a50343-11d7-4f01-b5ca-cf495278c0a8"))).abi_LogMessage(hstring(eventString).handle));
	}
	final void LogMessageWithLevel(wstring eventString, Windows.Foundation.Diagnostics.LoggingLevel level)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingChannel)this.asInterface(uuid("e9a50343-11d7-4f01-b5ca-cf495278c0a8"))).abi_LogMessageWithLevel(hstring(eventString).handle, level));
	}
	alias LogMessage = LogMessageWithLevel;
	final void LogValuePair(wstring value1, INT32 value2)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingChannel)this.asInterface(uuid("e9a50343-11d7-4f01-b5ca-cf495278c0a8"))).abi_LogValuePair(hstring(value1).handle, value2));
	}
	final void LogValuePairWithLevel(wstring value1, INT32 value2, Windows.Foundation.Diagnostics.LoggingLevel level)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingChannel)this.asInterface(uuid("e9a50343-11d7-4f01-b5ca-cf495278c0a8"))).abi_LogValuePairWithLevel(hstring(value1).handle, value2, level));
	}
	...
	alias StartActivity = StartActivityWithFieldsAndOptions;
	deprecated("This constructor creates a LoggingChannel in Windows 8.1 compatibility mode. Prefer the two-parameter constructor.")
	static Windows.Foundation.Diagnostics.LoggingChannel New(wstring name)
	{
		auto factory = factory!(Windows.Foundation.Diagnostics.ILoggingChannelFactory);
		Windows.Foundation.Diagnostics.LoggingChannel _ret;
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingChannelFactory)factory.asInterface(uuid("4edc5b9c-af80-4a9b-b0dc-398f9ae5207b"))).abi_Create(hstring(name).handle, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	final void BeginStruct(wstring name)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_BeginStruct(hstring(name).handle));
	}
	final void BeginStructWithTags(wstring name, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_BeginStructWithTags(hstring(name).handle, tags));
	}
	...
	final void AddEmpty(wstring name)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddEmpty(hstring(name).handle));
	}
	final void AddEmptyWithFormat(wstring name, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddEmptyWithFormat(hstring(name).handle, format));
	}
	alias AddEmpty = AddEmptyWithFormat;
	final void AddEmptyWithFormatAndTags(wstring name, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddEmptyWithFormatAndTags(hstring(name).handle, format, tags));
	}
	alias AddEmpty = AddEmptyWithFormatAndTags;
	final void AddUInt8(wstring name, ubyte value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt8(hstring(name).handle, value));
	}
	final void AddUInt8WithFormat(wstring name, ubyte value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt8WithFormat(hstring(name).handle, value, format));
	}
	alias AddUInt8 = AddUInt8WithFormat;
	final void AddUInt8WithFormatAndTags(wstring name, ubyte value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt8WithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddUInt8 = AddUInt8WithFormatAndTags;
	final void AddUInt8Array(wstring name, UINT32 __valueSize, ubyte* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt8Array(hstring(name).handle, __valueSize, value));
	}
	final void AddUInt8ArrayWithFormat(wstring name, UINT32 __valueSize, ubyte* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt8ArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddUInt8Array = AddUInt8ArrayWithFormat;
	final void AddUInt8ArrayWithFormatAndTags(wstring name, UINT32 __valueSize, ubyte* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt8ArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddUInt8Array = AddUInt8ArrayWithFormatAndTags;
	final void AddInt16(wstring name, INT16 value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt16(hstring(name).handle, value));
	}
	final void AddInt16WithFormat(wstring name, INT16 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt16WithFormat(hstring(name).handle, value, format));
	}
	alias AddInt16 = AddInt16WithFormat;
	final void AddInt16WithFormatAndTags(wstring name, INT16 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt16WithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddInt16 = AddInt16WithFormatAndTags;
	final void AddInt16Array(wstring name, UINT32 __valueSize, INT16* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt16Array(hstring(name).handle, __valueSize, value));
	}
	final void AddInt16ArrayWithFormat(wstring name, UINT32 __valueSize, INT16* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt16ArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddInt16Array = AddInt16ArrayWithFormat;
	final void AddInt16ArrayWithFormatAndTags(wstring name, UINT32 __valueSize, INT16* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt16ArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddInt16Array = AddInt16ArrayWithFormatAndTags;
	final void AddUInt16(wstring name, UINT16 value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt16(hstring(name).handle, value));
	}
	final void AddUInt16WithFormat(wstring name, UINT16 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt16WithFormat(hstring(name).handle, value, format));
	}
	alias AddUInt16 = AddUInt16WithFormat;
	final void AddUInt16WithFormatAndTags(wstring name, UINT16 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt16WithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddUInt16 = AddUInt16WithFormatAndTags;
	final void AddUInt16Array(wstring name, UINT32 __valueSize, UINT16* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt16Array(hstring(name).handle, __valueSize, value));
	}
	final void AddUInt16ArrayWithFormat(wstring name, UINT32 __valueSize, UINT16* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt16ArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddUInt16Array = AddUInt16ArrayWithFormat;
	final void AddUInt16ArrayWithFormatAndTags(wstring name, UINT32 __valueSize, UINT16* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt16ArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddUInt16Array = AddUInt16ArrayWithFormatAndTags;
	final void AddInt32(wstring name, INT32 value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt32(hstring(name).handle, value));
	}
	final void AddInt32WithFormat(wstring name, INT32 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt32WithFormat(hstring(name).handle, value, format));
	}
	alias AddInt32 = AddInt32WithFormat;
	final void AddInt32WithFormatAndTags(wstring name, INT32 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt32WithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddInt32 = AddInt32WithFormatAndTags;
	final void AddInt32Array(wstring name, UINT32 __valueSize, INT32* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt32Array(hstring(name).handle, __valueSize, value));
	}
	final void AddInt32ArrayWithFormat(wstring name, UINT32 __valueSize, INT32* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt32ArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddInt32Array = AddInt32ArrayWithFormat;
	final void AddInt32ArrayWithFormatAndTags(wstring name, UINT32 __valueSize, INT32* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt32ArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddInt32Array = AddInt32ArrayWithFormatAndTags;
	final void AddUInt32(wstring name, UINT32 value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt32(hstring(name).handle, value));
	}
	final void AddUInt32WithFormat(wstring name, UINT32 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt32WithFormat(hstring(name).handle, value, format));
	}
	alias AddUInt32 = AddUInt32WithFormat;
	final void AddUInt32WithFormatAndTags(wstring name, UINT32 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt32WithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddUInt32 = AddUInt32WithFormatAndTags;
	final void AddUInt32Array(wstring name, UINT32 __valueSize, UINT32* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt32Array(hstring(name).handle, __valueSize, value));
	}
	final void AddUInt32ArrayWithFormat(wstring name, UINT32 __valueSize, UINT32* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt32ArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddUInt32Array = AddUInt32ArrayWithFormat;
	final void AddUInt32ArrayWithFormatAndTags(wstring name, UINT32 __valueSize, UINT32* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt32ArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddUInt32Array = AddUInt32ArrayWithFormatAndTags;
	final void AddInt64(wstring name, INT64 value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt64(hstring(name).handle, value));
	}
	final void AddInt64WithFormat(wstring name, INT64 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt64WithFormat(hstring(name).handle, value, format));
	}
	alias AddInt64 = AddInt64WithFormat;
	final void AddInt64WithFormatAndTags(wstring name, INT64 value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt64WithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddInt64 = AddInt64WithFormatAndTags;
	final void AddInt64Array(wstring name, UINT32 __valueSize, INT64* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt64Array(hstring(name).handle, __valueSize, value));
	}
	final void AddInt64ArrayWithFormat(wstring name, UINT32 __valueSize, INT64* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt64ArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddInt64Array = AddInt64ArrayWithFormat;
	final void AddInt64ArrayWithFormatAndTags(wstring name, UINT32 __valueSize, INT64* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddInt64ArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddInt64Array = AddInt64ArrayWithFormatAndTags;
	final void AddUInt64(wstring name, ulong value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt64(hstring(name).handle, value));
	}
	final void AddUInt64WithFormat(wstring name, ulong value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt64WithFormat(hstring(name).handle, value, format));
	}
	alias AddUInt64 = AddUInt64WithFormat;
	final void AddUInt64WithFormatAndTags(wstring name, ulong value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt64WithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddUInt64 = AddUInt64WithFormatAndTags;
	final void AddUInt64Array(wstring name, UINT32 __valueSize, ulong* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt64Array(hstring(name).handle, __valueSize, value));
	}
	final void AddUInt64ArrayWithFormat(wstring name, UINT32 __valueSize, ulong* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt64ArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddUInt64Array = AddUInt64ArrayWithFormat;
	final void AddUInt64ArrayWithFormatAndTags(wstring name, UINT32 __valueSize, ulong* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddUInt64ArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddUInt64Array = AddUInt64ArrayWithFormatAndTags;
	final void AddSingle(wstring name, float value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSingle(hstring(name).handle, value));
	}
	final void AddSingleWithFormat(wstring name, float value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSingleWithFormat(hstring(name).handle, value, format));
	}
	alias AddSingle = AddSingleWithFormat;
	final void AddSingleWithFormatAndTags(wstring name, float value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSingleWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddSingle = AddSingleWithFormatAndTags;
	final void AddSingleArray(wstring name, UINT32 __valueSize, float* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSingleArray(hstring(name).handle, __valueSize, value));
	}
	final void AddSingleArrayWithFormat(wstring name, UINT32 __valueSize, float* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSingleArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddSingleArray = AddSingleArrayWithFormat;
	final void AddSingleArrayWithFormatAndTags(wstring name, UINT32 __valueSize, float* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSingleArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddSingleArray = AddSingleArrayWithFormatAndTags;
	final void AddDouble(wstring name, double value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDouble(hstring(name).handle, value));
	}
	final void AddDoubleWithFormat(wstring name, double value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDoubleWithFormat(hstring(name).handle, value, format));
	}
	alias AddDouble = AddDoubleWithFormat;
	final void AddDoubleWithFormatAndTags(wstring name, double value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDoubleWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddDouble = AddDoubleWithFormatAndTags;
	final void AddDoubleArray(wstring name, UINT32 __valueSize, double* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDoubleArray(hstring(name).handle, __valueSize, value));
	}
	final void AddDoubleArrayWithFormat(wstring name, UINT32 __valueSize, double* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDoubleArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddDoubleArray = AddDoubleArrayWithFormat;
	final void AddDoubleArrayWithFormatAndTags(wstring name, UINT32 __valueSize, double* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDoubleArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddDoubleArray = AddDoubleArrayWithFormatAndTags;
	final void AddChar16(wstring name, wchar value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddChar16(hstring(name).handle, value));
	}
	final void AddChar16WithFormat(wstring name, wchar value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddChar16WithFormat(hstring(name).handle, value, format));
	}
	alias AddChar16 = AddChar16WithFormat;
	final void AddChar16WithFormatAndTags(wstring name, wchar value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddChar16WithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddChar16 = AddChar16WithFormatAndTags;
	final void AddChar16Array(wstring name, UINT32 __valueSize, wchar* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddChar16Array(hstring(name).handle, __valueSize, value));
	}
	final void AddChar16ArrayWithFormat(wstring name, UINT32 __valueSize, wchar* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddChar16ArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddChar16Array = AddChar16ArrayWithFormat;
	final void AddChar16ArrayWithFormatAndTags(wstring name, UINT32 __valueSize, wchar* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddChar16ArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddChar16Array = AddChar16ArrayWithFormatAndTags;
	final void AddBoolean(wstring name, bool value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddBoolean(hstring(name).handle, value));
	}
	final void AddBooleanWithFormat(wstring name, bool value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddBooleanWithFormat(hstring(name).handle, value, format));
	}
	alias AddBoolean = AddBooleanWithFormat;
	final void AddBooleanWithFormatAndTags(wstring name, bool value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddBooleanWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddBoolean = AddBooleanWithFormatAndTags;
	final void AddBooleanArray(wstring name, UINT32 __valueSize, bool* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddBooleanArray(hstring(name).handle, __valueSize, value));
	}
	final void AddBooleanArrayWithFormat(wstring name, UINT32 __valueSize, bool* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddBooleanArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddBooleanArray = AddBooleanArrayWithFormat;
	final void AddBooleanArrayWithFormatAndTags(wstring name, UINT32 __valueSize, bool* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddBooleanArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddBooleanArray = AddBooleanArrayWithFormatAndTags;
	final void AddString(wstring name, wstring value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddString(hstring(name).handle, hstring(value).handle));
	}
	final void AddStringWithFormat(wstring name, wstring value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddStringWithFormat(hstring(name).handle, hstring(value).handle, format));
	}
	alias AddString = AddStringWithFormat;
	final void AddStringWithFormatAndTags(wstring name, wstring value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddStringWithFormatAndTags(hstring(name).handle, hstring(value).handle, format, tags));
	}
	alias AddString = AddStringWithFormatAndTags;
	final void AddStringArray(wstring name, UINT32 __valueSize, HSTRING* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddStringArray(hstring(name).handle, __valueSize, value));
	}
	final void AddStringArrayWithFormat(wstring name, UINT32 __valueSize, HSTRING* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddStringArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddStringArray = AddStringArrayWithFormat;
	final void AddStringArrayWithFormatAndTags(wstring name, UINT32 __valueSize, HSTRING* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddStringArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddStringArray = AddStringArrayWithFormatAndTags;
	final void AddGuid(wstring name, GUID value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddGuid(hstring(name).handle, value));
	}
	final void AddGuidWithFormat(wstring name, GUID value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddGuidWithFormat(hstring(name).handle, value, format));
	}
	alias AddGuid = AddGuidWithFormat;
	final void AddGuidWithFormatAndTags(wstring name, GUID value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddGuidWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddGuid = AddGuidWithFormatAndTags;
	final void AddGuidArray(wstring name, UINT32 __valueSize, GUID* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddGuidArray(hstring(name).handle, __valueSize, value));
	}
	final void AddGuidArrayWithFormat(wstring name, UINT32 __valueSize, GUID* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddGuidArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddGuidArray = AddGuidArrayWithFormat;
	final void AddGuidArrayWithFormatAndTags(wstring name, UINT32 __valueSize, GUID* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddGuidArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddGuidArray = AddGuidArrayWithFormatAndTags;
	final void AddDateTime(wstring name, Windows.Foundation.DateTime value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDateTime(hstring(name).handle, value));
	}
	final void AddDateTimeWithFormat(wstring name, Windows.Foundation.DateTime value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDateTimeWithFormat(hstring(name).handle, value, format));
	}
	alias AddDateTime = AddDateTimeWithFormat;
	final void AddDateTimeWithFormatAndTags(wstring name, Windows.Foundation.DateTime value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDateTimeWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddDateTime = AddDateTimeWithFormatAndTags;
	final void AddDateTimeArray(wstring name, UINT32 __valueSize, Windows.Foundation.DateTime* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDateTimeArray(hstring(name).handle, __valueSize, value));
	}
	final void AddDateTimeArrayWithFormat(wstring name, UINT32 __valueSize, Windows.Foundation.DateTime* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDateTimeArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddDateTimeArray = AddDateTimeArrayWithFormat;
	final void AddDateTimeArrayWithFormatAndTags(wstring name, UINT32 __valueSize, Windows.Foundation.DateTime* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddDateTimeArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddDateTimeArray = AddDateTimeArrayWithFormatAndTags;
	final void AddTimeSpan(wstring name, Windows.Foundation.TimeSpan value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddTimeSpan(hstring(name).handle, value));
	}
	final void AddTimeSpanWithFormat(wstring name, Windows.Foundation.TimeSpan value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddTimeSpanWithFormat(hstring(name).handle, value, format));
	}
	alias AddTimeSpan = AddTimeSpanWithFormat;
	final void AddTimeSpanWithFormatAndTags(wstring name, Windows.Foundation.TimeSpan value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddTimeSpanWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddTimeSpan = AddTimeSpanWithFormatAndTags;
	final void AddTimeSpanArray(wstring name, UINT32 __valueSize, Windows.Foundation.TimeSpan* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddTimeSpanArray(hstring(name).handle, __valueSize, value));
	}
	final void AddTimeSpanArrayWithFormat(wstring name, UINT32 __valueSize, Windows.Foundation.TimeSpan* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddTimeSpanArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddTimeSpanArray = AddTimeSpanArrayWithFormat;
	final void AddTimeSpanArrayWithFormatAndTags(wstring name, UINT32 __valueSize, Windows.Foundation.TimeSpan* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddTimeSpanArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddTimeSpanArray = AddTimeSpanArrayWithFormatAndTags;
	final void AddPoint(wstring name, Windows.Foundation.Point value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddPoint(hstring(name).handle, value));
	}
	final void AddPointWithFormat(wstring name, Windows.Foundation.Point value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddPointWithFormat(hstring(name).handle, value, format));
	}
	alias AddPoint = AddPointWithFormat;
	final void AddPointWithFormatAndTags(wstring name, Windows.Foundation.Point value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddPointWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddPoint = AddPointWithFormatAndTags;
	final void AddPointArray(wstring name, UINT32 __valueSize, Windows.Foundation.Point* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddPointArray(hstring(name).handle, __valueSize, value));
	}
	final void AddPointArrayWithFormat(wstring name, UINT32 __valueSize, Windows.Foundation.Point* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddPointArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddPointArray = AddPointArrayWithFormat;
	final void AddPointArrayWithFormatAndTags(wstring name, UINT32 __valueSize, Windows.Foundation.Point* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddPointArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddPointArray = AddPointArrayWithFormatAndTags;
	final void AddSize(wstring name, Windows.Foundation.Size value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSize(hstring(name).handle, value));
	}
	final void AddSizeWithFormat(wstring name, Windows.Foundation.Size value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSizeWithFormat(hstring(name).handle, value, format));
	}
	alias AddSize = AddSizeWithFormat;
	final void AddSizeWithFormatAndTags(wstring name, Windows.Foundation.Size value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSizeWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddSize = AddSizeWithFormatAndTags;
	final void AddSizeArray(wstring name, UINT32 __valueSize, Windows.Foundation.Size* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSizeArray(hstring(name).handle, __valueSize, value));
	}
	final void AddSizeArrayWithFormat(wstring name, UINT32 __valueSize, Windows.Foundation.Size* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSizeArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddSizeArray = AddSizeArrayWithFormat;
	final void AddSizeArrayWithFormatAndTags(wstring name, UINT32 __valueSize, Windows.Foundation.Size* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddSizeArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
	alias AddSizeArray = AddSizeArrayWithFormatAndTags;
	final void AddRect(wstring name, Windows.Foundation.Rect value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddRect(hstring(name).handle, value));
	}
	final void AddRectWithFormat(wstring name, Windows.Foundation.Rect value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddRectWithFormat(hstring(name).handle, value, format));
	}
	alias AddRect = AddRectWithFormat;
	final void AddRectWithFormatAndTags(wstring name, Windows.Foundation.Rect value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddRectWithFormatAndTags(hstring(name).handle, value, format, tags));
	}
	alias AddRect = AddRectWithFormatAndTags;
	final void AddRectArray(wstring name, UINT32 __valueSize, Windows.Foundation.Rect* value)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddRectArray(hstring(name).handle, __valueSize, value));
	}
	final void AddRectArrayWithFormat(wstring name, UINT32 __valueSize, Windows.Foundation.Rect* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddRectArrayWithFormat(hstring(name).handle, __valueSize, value, format));
	}
	alias AddRectArray = AddRectArrayWithFormat;
	final void AddRectArrayWithFormatAndTags(wstring name, UINT32 __valueSize, Windows.Foundation.Rect* value, Windows.Foundation.Diagnostics.LoggingFieldFormat format, INT32 tags)
	{
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingFields)this.asInterface(uuid("d7f6b7af-762d-4579-83bd-52c23bc333bc"))).abi_AddRectArrayWithFormatAndTags(hstring(name).handle, __valueSize, value, format, tags));
	}
...
extern(Windows):
	...
	final Windows.Foundation.IAsyncOperation!(Windows.Storage.StorageFile) SaveToFileAsync(Windows.Storage.IStorageFolder folder, wstring fileName)
	{
		Windows.Foundation.IAsyncOperation!(Windows.Storage.StorageFile) _ret;
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingSession)this.asInterface(uuid("6221f306-9380-4ad7-baf5-41ea9310d768"))).abi_SaveToFileAsync(folder, hstring(fileName).handle, &_ret));
		return _ret;
	}
	final void AddLoggingChannel(Windows.Foundation.Diagnostics.ILoggingChannel loggingChannel)
	{
	...
	static Windows.Foundation.Diagnostics.LoggingSession New(wstring name)
	{
		...
		Debug.OK((cast(Windows.Foundation.Diagnostics.ILoggingSessionFactory)factory.asInterface(uuid("4e937ee5-58fd-45e0-8c2f-a132eff95c1e"))).abi_Create(hstring(name).handle, &_ret));
		return _ret;
	}
}
