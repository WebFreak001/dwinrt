...
extern(Windows):
	...
	{
		double _ret;
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackEffect)this.asInterface(uuid("a17fba0c-2ae4-48c2-8063-eabd0777cb89"))).get_Gain(&_ret));
		return _ret;
	}
	final void Gain(double value)
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackEffect)this.asInterface(uuid("a17fba0c-2ae4-48c2-8063-eabd0777cb89"))).set_Gain(value));
	}
	final Windows.Gaming.Input.ForceFeedback.ForceFeedbackEffectState State()
	{
		...
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackEffect)this.asInterface(uuid("a17fba0c-2ae4-48c2-8063-eabd0777cb89"))).get_State(&_ret));
		return _ret;
	}
	final void Start()
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackEffect)this.asInterface(uuid("a17fba0c-2ae4-48c2-8063-eabd0777cb89"))).abi_Start());
	}
	final void Stop()
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackEffect)this.asInterface(uuid("a17fba0c-2ae4-48c2-8063-eabd0777cb89"))).abi_Stop());
	}
	final Windows.Gaming.Input.ForceFeedback.ConditionForceEffectKind Kind()
	{
		...
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IConditionForceEffect)this.asInterface(uuid("32d1ea68-3695-4e69-85c0-cd1944189140"))).get_Kind(&_ret));
		return _ret;
	}
	...
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IConditionForceEffect)this.asInterface(uuid("32d1ea68-3695-4e69-85c0-cd1944189140"))).abi_SetParameters(direction, positiveCoefficient, negativeCoefficient, maxPositiveMagnitude, maxNegativeMagnitude, deadZone, bias));
	}
	static Windows.Gaming.Input.ForceFeedback.ConditionForceEffect New(Windows.Gaming.Input.ForceFeedback.ConditionForceEffectKind effectKind)
	{
		...
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IConditionForceEffectFactory)factory.asInterface(uuid("91a99264-1810-4eb6-a773-bfd3b8cddbab"))).abi_CreateInstance(effectKind, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IConstantForceEffect)this.asInterface(uuid("9bfa0140-f3c7-415c-b068-0f068734bce0"))).abi_SetParameters(vector, duration));
	}
	...
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IConstantForceEffect)this.asInterface(uuid("9bfa0140-f3c7-415c-b068-0f068734bce0"))).abi_SetParametersWithEnvelope(vector, attackGain, sustainGain, releaseGain, startDelay, attackDuration, sustainDuration, releaseDuration, repeatCount));
	}
	static ConstantForceEffect New()
	{
		IInspectable ret;
		Debug.OK(activationFactory!(ConstantForceEffect).abi_ActivateInstance(&ret));
		return cast(ConstantForceEffect) ret;
	}
}
...
extern(Windows):
	...
	{
		bool _ret;
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).get_AreEffectsPaused(&_ret));
		return _ret;
	}
	final double MasterGain()
	{
		double _ret;
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).get_MasterGain(&_ret));
		return _ret;
	}
	final void MasterGain(double value)
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).set_MasterGain(value));
	}
	final bool IsEnabled()
	{
		bool _ret;
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).get_IsEnabled(&_ret));
		return _ret;
	}
	final Windows.Gaming.Input.ForceFeedback.ForceFeedbackEffectAxes SupportedAxes()
	{
		...
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).get_SupportedAxes(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(Windows.Gaming.Input.ForceFeedback.ForceFeedbackLoadEffectResult) LoadEffectAsync(Windows.Gaming.Input.ForceFeedback.IForceFeedbackEffect effect)
	{
		...
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).abi_LoadEffectAsync(effect, &_ret));
		return _ret;
	}
	final void PauseAllEffects()
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).abi_PauseAllEffects());
	}
	final void ResumeAllEffects()
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).abi_ResumeAllEffects());
	}
	final void StopAllEffects()
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).abi_StopAllEffects());
	}
	final Windows.Foundation.IAsyncOperation!(bool) TryDisableAsync()
	{
		Windows.Foundation.IAsyncOperation!(bool) _ret;
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).abi_TryDisableAsync(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(bool) TryEnableAsync()
	{
		Windows.Foundation.IAsyncOperation!(bool) _ret;
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).abi_TryEnableAsync(&_ret));
		return _ret;
	}
	final Windows.Foundation.IAsyncOperation!(bool) TryResetAsync()
	{
		Windows.Foundation.IAsyncOperation!(bool) _ret;
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).abi_TryResetAsync(&_ret));
		return _ret;
	}
	...
	{
		Windows.Foundation.IAsyncOperation!(bool) _ret;
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IForceFeedbackMotor)this.asInterface(uuid("8d3d417c-a5ea-4516-8026-2b00f74ef6e5"))).abi_TryUnloadEffectAsync(effect, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	final Windows.Gaming.Input.ForceFeedback.PeriodicForceEffectKind Kind()
	{
		...
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IPeriodicForceEffect)this.asInterface(uuid("5c5138d7-fc75-4d52-9a0a-efe4cab5fe64"))).get_Kind(&_ret));
		return _ret;
	}
	...
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IPeriodicForceEffect)this.asInterface(uuid("5c5138d7-fc75-4d52-9a0a-efe4cab5fe64"))).abi_SetParameters(vector, frequency, phase, bias, duration));
	}
	...
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IPeriodicForceEffect)this.asInterface(uuid("5c5138d7-fc75-4d52-9a0a-efe4cab5fe64"))).abi_SetParametersWithEnvelope(vector, frequency, phase, bias, attackGain, sustainGain, releaseGain, startDelay, attackDuration, sustainDuration, releaseDuration, repeatCount));
	}
	static Windows.Gaming.Input.ForceFeedback.PeriodicForceEffect New(Windows.Gaming.Input.ForceFeedback.PeriodicForceEffectKind effectKind)
	{
		...
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IPeriodicForceEffectFactory)factory.asInterface(uuid("6f62eb1a-9851-477b-b318-35ecaa15070f"))).abi_CreateInstance(effectKind, &_ret));
		return _ret;
	}
}
...
extern(Windows):
	...
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IRampForceEffect)this.asInterface(uuid("f1f81259-1ca6-4080-b56d-b43f3354d052"))).abi_SetParameters(startVector, endVector, duration));
	}
	...
	{
		Debug.OK((cast(Windows.Gaming.Input.ForceFeedback.IRampForceEffect)this.asInterface(uuid("f1f81259-1ca6-4080-b56d-b43f3354d052"))).abi_SetParametersWithEnvelope(startVector, endVector, attackGain, sustainGain, releaseGain, startDelay, attackDuration, sustainDuration, releaseDuration, repeatCount));
	}
	static RampForceEffect New()
	{
		IInspectable ret;
		Debug.OK(activationFactory!(RampForceEffect).abi_ActivateInstance(&ret));
		return cast(RampForceEffect) ret;
	}
}
