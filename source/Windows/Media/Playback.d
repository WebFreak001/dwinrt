...
@WinrtFactory("Windows.Media.Playback.CurrentMediaPlaybackItemChangedEventArgs")
interface ICurrentMediaPlaybackItemChangedEventArgs2_Base : IInspectable
{
extern(Windows):
...
interface IMediaPlaybackItem_Base : IInspectable
{
extern(Windows):
...
@WinrtFactory("Windows.Media.Playback.MediaPlaybackItem")
interface IMediaPlaybackItem2_Base : IInspectable
{
extern(Windows):
...
@WinrtFactory("Windows.Media.Playback.MediaPlaybackItem")
interface IMediaPlaybackItem3_Base : IInspectable
{
extern(Windows):
...
@WinrtFactory("Windows.Media.Playback.MediaPlaybackItem")
interface IMediaPlaybackItemFactory2_Base : IInspectable
{
extern(Windows):
...
interface IMediaPlaybackList_Base : IInspectable
{
extern(Windows):
...
@WinrtFactory("Windows.Media.Playback.MediaPlaybackList")
interface IMediaPlaybackList2_Base : IInspectable
{
extern(Windows):
...
@WinrtFactory("Windows.Media.Playback.MediaPlaybackList")
interface IMediaPlaybackList3_Base : IInspectable
{
extern(Windows):
...
interface IPlaybackMediaMarkerSequence_Base : IInspectable
{
extern(Windows):
